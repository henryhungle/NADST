...
parser.add_argument('-d2s_nn_N', '--domain2slot_nn_N', help='', required=False, type=int, default=6)
parser.add_argument('-s2s_nn_N', '--slot2state_nn_N', help='', required=False, type=int, default=6)
parser.add_argument('-d', '--d_model', help='', required=False, type=int, default=512)
parser.add_argument('-d_emb', '--d_embed', help='', required=False, type=int, default=-1)
parser.add_argument('-h_attn', '--h_attn', help='', required=False, type=int, default=8)
